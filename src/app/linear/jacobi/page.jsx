...
import { Jacobi_func } from "./Jacobi_func";
...
function Jacobi() {
  ...
  let [matrixX, setMatrixX] = useState(new Array(matrixDimension).fill(""));
  ...
  function updateCellX(row, value) {
    let newMatrixX = [...matrixX];
  ...
  function Calculate() {
    ...
    let result = Jacobi_func(matrixA, matrixB, epsilon);
    setAns(result);
  }
  ...
  return (
    <div className="container mt-5 mb-5">
      <div className="text-center mb-5">
        <h1 className="text-3xl font-bold">Jacobi Elimination</h1>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div>
          <div className="card mb-5">
            <div className="text-center mb-5">
              ...
              <label htmlFor="matrix-dimension" className="text-lg font-bold">Epsilon : </label>
              <div className="relative ml-2">
                <input
                  type="number"
                  id="matrix-dimension"
        ...
        <div>
          <div className="card mb-5">
            ...
            {/* ช่องตาราง กรอก ค่า {x} สร้างขึ้นคาม จำนวนช่องตาราง */}
            <div className="text-center font-bold mt-3">
                  ...
                  <tr key={rowIndex}>
                    <td>
                      <TextField
                        ...
                        placeholder="0"
                        onChange={(e) => {
                          updateCellX(rowIndex, e.target.value);
                        }}
                      />
                    </td>
                  </tr>
