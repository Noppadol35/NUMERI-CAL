...
import { Graphical_func } from "./Graphical_func.js";
...
function Graphcial() {
  ...
  async function calculate() {
    ...
    let result = await Graphical_func(equation, xstart, xend, epsilon);

    // Ensure that `result` is an array of objects
  ...
  async function runGraphicalMethod() {
    try {
      const result = await Graphical_func(equation, xstart, xend, epsilon);
      console.log(result);
    } catch (error) {
  ...
  return (
    <div className="container mx-auto px-4 py-5 text-center">
      <h1 className="text-2xl font-bold md-4">Graphcial Method</h1>
                ...
                data={[
                  {
                    ...
                    type: "scatter",
                    mode: "lines+markers",
                    name: "Graphcial Method",
                  },
                ]}
                layout={{
                  width: 600,
                  height: 400,
                  title: "Graphcial Method Graph",
                  xaxis: { title: "Xm" },
                  yaxis: { title: "Yk" },
                }}
              />
