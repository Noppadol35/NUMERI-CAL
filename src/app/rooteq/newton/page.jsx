...
import { OnePoint_func } from "../onepoint/OnePoint_func.js";
...
function NewtonRoot() {
  ...
  function calculate() {
    ...
    let result = OnePoint_func(equation, xstart, xend, epsilon);
    setData(result);
    setPage(0);
  }
  ...
  return (
    <div className="container mx-auto px-4 py-5 text-center">
      <h1 className="text-2xl font-bold md-4">Newton's Method</h1>
                ...
                data={[
                  {
                    ...
                    type: "scatter",
                    mode: "lines+markers",
                    name: "NewtonRoot Method",
                  },
                ]}
                layout={{
                  width: 600,
                  height: 400,
                  title: "NewtonRoot Method Graph",
                  xaxis: { title: "Xm" },
                  yaxis: { title: "Yk" },
                }}
              />
