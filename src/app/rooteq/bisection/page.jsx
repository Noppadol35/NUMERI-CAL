...
import { Bisection_func } from "./Bisection_func.js";
...
function Bisection() {
  ...
  function calculate() {
    ...
    let result = Bisection_func(equation, xstart, xend, epsilon);
    setData(result);
    setPage(0);
  }
  ...
  return (
    <div className="container mx-auto px-4 py-5 text-center">
      <h1 className="text-2xl font-bold md-4">Bisection Method</h1>
