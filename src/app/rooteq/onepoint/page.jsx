...
import { OnePoint_func } from "./OnePoint_func.js";
...
function OnePoint() {
  ...
  return (
    <div className="container mx-auto px-4 py-5 text-center">
      <h1 className="text-2xl font-bold md-4">One-Point Position Method</h1>
                ...
                data={[
                  {
                    ...
                    type: "scatter",
                    mode: "lines+markers",
                    name: "OnePoint Method",
                  },
                ]}
                layout={{
                  width: 600,
                  height: 400,
                  title: "OnePoint Method Graph",
                  xaxis: { title: "Xm" },
                  yaxis: { title: "Yk" },
                }}
              />
