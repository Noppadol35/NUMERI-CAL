...
export function trapezoidal_func(functionText, a, b) {
    function f(x) {
...
// const a = 2; // จุดเริ่ม
// const b = 8; // จุดจบ
// const n = 1; // จำนวนขั้นบันได

// const result = trapezoidal_func(functionText, a, b, n);
// console.log(`พื้นที่ใต้กราฟของ ${functionText} ระหว่าง ${a} และ ${b} คือ ${result}`);
// console.log(`ความคลาดเคลื่อน: ${error}`);
